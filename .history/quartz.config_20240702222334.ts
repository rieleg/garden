  ...
  configuration: {
    ...
    theme: {
      ...
      colors: {
        lightMode: {
          light: "#e0e7e9", // #faf8f8
          lightgray: "#5c5c5c40", // #e5e5e5
          gray: "#5c636e", // #b8b8b8
          darkgray: "#333333", // #4e4e4e
          dark: "#2b2b2b", // #2b2b2b
          secondary: "#40857c", // #284b63
          tertiary: "#5da399", // #84a59d
          highlight: "#40867d20", // rgba(143, 159, 169, 0.15)
        },
        darkMode: {
          light: "#1e1e1e", // 页面背景 #161618
          lightgray: "#2e8b5740", // 边框 #393639
          ...
          highlight: "#e8d7b820", // 内部链接背景、突出显示文本、高亮代码 rgba(143, 159, 169, 0.15)
        },
      },
    },
  },
